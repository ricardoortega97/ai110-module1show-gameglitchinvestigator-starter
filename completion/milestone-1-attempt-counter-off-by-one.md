...
**Tests added:** `test_score_win_on_corrected_first_attempt`, `test_parse_guess_string_input`, `test_parse_guess_negative_number`, `test_parse_guess_empty_input` (in `tests/test_milestone1.py`)
